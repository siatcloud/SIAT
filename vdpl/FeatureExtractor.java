...
public class FeatureExtractor {
    public static void FeatureExtractor(String data_url, String result_url) throws Exception, IOException {
        ...
        //SparkConf conf = new SparkConf().setAppName("ucf11").setMaster("yarn-cluster").set("spark.executor.instances", "4").set("spark.executor.memory", "512M").set("spark.executor.cores", "2").set("spark.driver.allowMultipleContexts", "true");
...
//	long[][] posdescriptors = new long[27][16384];
   ...
   //         System.out.println(parts[0]);
            ...
            if (Integer.valueOf(rever) >= 1 && Integer.valueOf(rever) <= 1) levelid = 1;
            else if (Integer.valueOf(rever) >= 2 && Integer.valueOf(rever) <= 2) levelid = 2;
            else if (Integer.valueOf(rever) >= 3 && Integer.valueOf(rever) <= 3) levelid = 3;
            else if (Integer.valueOf(rever) >= 4 && Integer.valueOf(rever) <= 4) levelid = 4;
            else if (Integer.valueOf(rever) >= 5 && Integer.valueOf(rever) <= 5) levelid = 5;
            else if (Integer.valueOf(rever) >= 6 && Integer.valueOf(rever) <= 6) levelid = 6;
            else if (Integer.valueOf(rever) >= 7 && Integer.valueOf(rever) <= 7) levelid = 7;
            else if (Integer.valueOf(rever) >= 8 && Integer.valueOf(rever) <= 8) levelid = 8;
            else if (Integer.valueOf(rever) >= 9 && Integer.valueOf(rever) <= 9) levelid = 9;
            else if (Integer.valueOf(rever) >= 10 && Integer.valueOf(rever) <= 10) levelid = 10;
...
//                grabber.setFormat("mpg");
                ...
                for (int k = 0; k < 200; k++) {
                    ...
                    } else if (frame_flag > 1 && frame_flag < 199) {
...
//           	   opencv_imgcodecs.imwrite("data/frames/"+Vdata+"_"+(k)+".jpg", mat1);
         	 ...
         	 /* for(int iii=0;iii<16384;iii++)
              {
        	   ...
        	   tem = tem+1;*/
                ...
                for (int iii = 0; iii < 16384; iii++) {
                    out.write(t3 + ":" + tmp2[iii] + " ");
                  //  System.out.println(t3 + ":" + tmp2[iii] + " ");
                    // System.out.println(tmp1[iii]+" ");
                }
                tmp2 = null;
                frame_flag = 0;
