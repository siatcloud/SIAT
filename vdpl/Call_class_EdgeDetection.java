...
public static void main(String[] args) throws Exception, IOException {
		...
		EdgeDetection.SobelOperator("data/HisEq_Dataset/","data/Equalize_frame/");
		//EdgeDetection.LaplacianOperator("data/HisEq_Dataset/","data/Equalize_frame/");
		//EdgeDetection.CannyOperator("data/HisEq_Dataset/","data/Equalize_frame/");
