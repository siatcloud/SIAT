...
public class StreamFaceDetector {
    public void detect(int serviceSuvscriptionid, int realtimeId) {
        ...
        try {
            ...
            Runtime.getRuntime().exec("mvn clean package exec:java -Dexec.mainClass=com.iot.video.app.spark.processor.VideoStreamProcessor -f /home/siyamul/video-stream-analytics-master/video-stream-processor/pom.xml -Dexec.args=face_#" + serviceSuvscriptionid + "_#" + topic);
