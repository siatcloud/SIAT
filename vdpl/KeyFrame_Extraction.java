...
public class KeyFrame_Extraction {
        ...
        for(int k= 0; k<frame_count; k++){	
        	...
        	*/
        	 ...
        	 Mat mat1 = new Mat(matImage.arrayHeight(),matImage.arrayWidth());
        	   ...
        	   LBP_Gray Frame1 = new LBP_Gray(mat3);
        	   LBP_Gray Frame2 = new LBP_Gray(mat1);
        	   int[] Frame1_tmp1 = Frame1.finaldes();
        	   int[] Frame2_tmp2 = Frame2.finaldes();
        	   int innerSum = 0,difference=0;
        	   ...
        	   difference=(int) Math.sqrt(innerSum);
