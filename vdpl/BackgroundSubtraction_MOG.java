...
public class BackgroundSubtraction_MOG {
public static void BackgroundSubtraction(String data_url, final String result_url) throws Exception, IOException {
    ...
    BackgroundSubtractorMOG2 backgroundSubtractorMOG = createBackgroundSubtractorMOG2(); 
