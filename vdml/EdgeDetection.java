...
public static void SobelOperator(String data_url, final String result_url) throws Exception, IOException {
        ...
        for(int k= 0; k<frame_count; k++){	
        	...
        	// Mat fgMask = new Mat(matImage3.arrayHeight(),matImage3.arrayWidth());
        	 ...
        	 //cvtColor(mat3, mat2, COLOR_GRAY2RGB);
        	   ...
        	   Mat fgMask2 = new Mat(sourceSingle);
        	   Mat AbsfgMask = new Mat(sourceSingle);
        	   Mat AbsfgMask2 = new Mat(sourceSingle);
        	   Mat FinalImage = new Mat(sourceSingle);
        	         	 
        	   Sobel(mat3, fgMask, CV_16S, 1, 0, 3, 1, 0, BORDER_DEFAULT);
        	   Sobel(mat3, fgMask2, CV_16S, 0, 1, 3, 1, 0, BORDER_DEFAULT);
        	   
        	   convertScaleAbs(fgMask, AbsfgMask);
        	   convertScaleAbs(fgMask2, AbsfgMask2);
        	   
        	   addWeighted(AbsfgMask, 0.5, AbsfgMask2, 0.5, 0, FinalImage);
        	   
        	   //backgroundSubtractorMOG.apply(mat2, fgMask);        
        	   IplImage img5 = new IplImage(FinalImage);
        	   //fgMask.release();
        	   //mat3.close();
        	   //fgMask.close();
...
public static void LaplacianOperator(String data_url, final String result_url) throws Exception, IOException {
    ...
    for(int k= 0; k<frame_count; k++){	
    	...
    	// Mat fgMask = new Mat(matImage3.arrayHeight(),matImage3.arrayWidth());
    	 ...
    	 //cvtColor(mat3, mat2, COLOR_GRAY2RGB);
    	   ...
    	   GaussianBlur(mat3, mat3, new Size(3, 3), 0, 0, BORDER_DEFAULT);
    	   
    	   Laplacian(mat3, fgMask, CV_16S, 3, 1, 0, BORDER_DEFAULT);
    	       	   
    	   convertScaleAbs(fgMask, AbsfgMask);
    	           
    	   IplImage img5 = new IplImage(AbsfgMask);
...
public static void CannyOperator(String data_url, final String result_url) throws Exception, IOException {
