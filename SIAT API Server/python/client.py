...
#
#
url_od = 'http://163.180.116.234:7777/ObjectDetection/'
# headers = {"content-type": "application/json", "Accept-Charset": "UTF-8"}
payload_od = {'data_path': 'khu/morshed/test1/12.avi', 'output_path': '1_1607325054.mp4'}
...
# User authentication
# url_od = 'http://163.180.116.234:7777/login/'
# # headers = {"content-type": "application/json", "Accept-Charset": "UTF-8"}
# payload_od = {'username': 'AnwarAbir', 'password': '1485'}
# r_post = requests.post(url_od, data=payload_od)
# data_for_post = r_post.json()
# print(data_for_post)

# #get video list
# url_od = 'http://163.180.116.234:7777/dbinfo/'
# # headers = {"content-type": "application/json", "Accept-Charset": "UTF-8"}
# payload_od = {'institute' : 'khu', 'username' : 'AnwarAbir', 'dbname' : 'stad'}
# r_post = requests.post(url_od, data=payload_od)
# data_for_post = r_post.json()
# print(data_for_post)

#cctv info
# url_od = 'http://163.180.116.234:7777/cctvInfo/'
# # headers = {"content-type": "application/json", "Accept-Charset": "UTF-8"}
# payload_od = {'username' : 'AnwarAbir', 'institute' : 'khu'}
# r_post = requests.post(url_od, data=payload_od)
# data_for_post = r_post.json()
# print(data_for_post)
