...
public class Test_RandomForest {
	...
	public static void classify(String data_url, final RandomForestModel model, String outputPath) throws IOException {
		System.setProperty("hadoop.home.dir", "C:\\Hadoop\\hadooponwindows-master\\");
		// $example on$
		SparkConf sparkConf = new SparkConf().setAppName("RandomForest").setMaster("local[*]");
//					.setMaster("yarn")
...
//			System.out.println("########################------ Number of Samples -------########################");
		...
		bw.append("------ Pairs of actual and predicted labels------");
		bw.newLine();
		bw.append("Test Error: " + testErr);
		bw.newLine();
		bw.append("Test Accuracy: " + (1 - testErr));
		bw.flush();
		bw.close();
